...
object ProjectWork_0702 {
  def main(args: Array[String]): Unit = {
    ...
    var finalResultDF = sortedFinalRdd.toDF("regionSeg1", "productSeg2", "regionSeg2", "regionSeg3", "productSeg3",
      "yearweek", "year", "week", "qty", "mapPrice", "ir", "pmap", "pmap10", "pro_percent", "promotion_yn")
